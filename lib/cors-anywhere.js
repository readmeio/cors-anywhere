...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    // README NOTE: We added in the options-bypass stuff so that people
    // using `OPTIONS` in readme don't always get a 200.
    if (req.method === 'OPTIONS' && !req.headers['options-bypass']) {
